...
const FAQS = [
  ...
  },
  {
    ...
    a: 'No. Because export factoring is not a loan, it typically does not appear as debt on your balance sheet for many companies. This keeps your financial ratios healthy and preserves your borrowing capacity for other needs.',
  },
  {
...
const BENEFITS = [
  ...
  },
  {
    ...
    desc: 'Steady cash flow means you can take on bigger orders, hire more staff, and invest in production without waiting for slow-paying buyers.',
    color: '#a78bfa',
  },
  {
    Icon: Globe,
...
const TESTIMONIALS = [
  {
    quote: 'Before Tradeflink, we waited months to receive payments from our overseas buyers. Now, we get paid within days. That stability has allowed us to take on bigger orders and grow our team.',
    name: 'Aisha Rahman',
...
/* ── Main Page ─────────────────────────────────────────────────── */
export default function ExportFactoring() {
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(to right, rgba(5,13,24,0.75) 0%, rgba(5,13,24,0.25) 60%, transparent 100%)' }} />
        <ParticleGrid />
        ...
        <div className="relative z-10 py-44 px-6 sm:px-10 lg:px-20 xl:px-28 max-w-7xl mx-auto w-full">
          ...
          >
            ...
            />
            <span className="text-teal-400 text-[10px] font-black uppercase tracking-[0.25em]">Trade Finance · SME Growth</span>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative rounded-3xl overflow-hidden aspect-4/3 group">
                <img
                  src={img2}
                  alt="Export factoring for global trade"
      ...
      <section className="section bg-white relative overflow-hidden">
        <div className="container-xl relative z-10">
          ...
          >
            ...
            <p className="text-slate-400 text-lg mt-5 max-w-xl mx-auto">
              Our export factoring solutions solve the exact problems SMEs face when trading internationally.
            </p>
          </motion.div>
      ...
      <section className="relative h-[440px] lg:h-[520px] overflow-hidden">
        <img
          src={img5}
          alt="Global trade finance operations"
      ...
      <section className="section bg-[#060f1e] relative overflow-hidden -mb-15">
        ...
        <div className="container-xl relative z-10">
          ...
          >
            ...
            <p className="text-slate-400 text-lg mt-5 max-w-xl mx-auto">
              Clear answers to the most common questions about export factoring with Tradeflink.
            </p>
          </motion.div>
        ...
        <div className="container-xl relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-gradient">limits, or delays.</span>
            </motion.h2>

            <motion.p variants={fadeUp} className="text-slate-400 text-xl max-w-lg mx-auto mb-12 leading-relaxed">
              Every day, hundreds of entrepreneurs take bold steps into new markets.
              With Tradeflink by your side, you'll never walk alone.
            </motion.p>
